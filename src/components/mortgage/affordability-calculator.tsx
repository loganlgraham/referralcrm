          ...
          <div className="space-y-4">
            <div className="rounded-lg border border-primary/20 bg-primary-soft p-4">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-semibold text-primary">Maximum Affordability</h3>
              </div>
                    ...
                    <div className="mt-1 h-2 overflow-hidden rounded-full bg-surface-subtle">
                      <div
                        className={`h-2 rounded-full ${
                          (results.housingExpenseRatio || 0) <= 0.28 ? 'bg-success' : 'bg-warning'
                        }`}
            ...
            {onUseResults && (
              <button
                ...
                className="w-full rounded-md bg-primary px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-primary-hover focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
              >
