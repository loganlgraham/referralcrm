...
import { AlertCircleIcon, LineChartIcon, NewspaperIcon, RefreshCwIcon, SparklesIcon } from 'lucide-react';
...
export function MortgageMarketInsights() {
  ...
  return (
    <div className="rounded-lg bg-white p-6 shadow-sm">
      ...
      {/* Live rate snapshot — widget full width */}
      <div className="mt-6 rounded-lg border border-slate-200 bg-slate-50/70 p-4">
        ...
        {/* Widget — full width, no side-by-side split */}
        <div className="overflow-hidden rounded-md border border-slate-200 bg-white shadow-sm">
          <div style={{ textAlign: 'center', padding: '6px 0', backgroundColor: '#0f172a', color: '#ffffff' }}>
        ...
        {/* Use with care — compact strip below widget */}
        <div className="mt-3 flex flex-col gap-2 rounded-md border border-amber-200 bg-amber-50 px-4 py-3 sm:flex-row sm:items-start sm:gap-3">
          ...
          <div className="flex flex-wrap gap-x-4 gap-y-1">
            ...
            <p className="text-xs text-amber-700">Quote specifics must come from the lender you're working with.</p>
          </div>
        </div>
      </div>

      {/* AI brief — balanced two-column layout */}
      <div className="mt-6 grid gap-5 lg:grid-cols-2">
        {/* Left: Headline summary + News headlines */}
        <div className="space-y-4">
          <div className="rounded-lg border border-slate-200 p-4">
            <h2 className="text-sm font-semibold text-slate-800">Today's market headline</h2>
        ...
        {/* Right: Coaching angles + Rate signals */}
        <div className="space-y-4">
          <div className="rounded-lg border border-slate-200 p-4">
            <div className="flex items-center gap-2 text-sm font-semibold text-slate-800">
              <SparklesIcon className="h-4 w-4 text-brand" />
              Coaching angles for today
            </div>
      ...
      {/* Borrower talking points — full width below */}
